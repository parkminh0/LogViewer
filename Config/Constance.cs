...
namespace LogViewer
{
    public class Constance
    {
        ...
        public string SystemTitle = "LogViewer";
        //-----------------------------------------------------------------------------------------------------------------//
        ...
        private string dbFileName = "LogViewer.db"; // SQLite
        ...
        private string dbBaseFileName = "LogViewer.db";
        private string dbInitFileName = "LogViewer.db";
        /// <summary>
        /// Initial DB Name
        /// </summary>
